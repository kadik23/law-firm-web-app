...
const BlogCommentFactory = (sequelize: Sequelize, DataTypes: typeof SequelizeDataTypes): ModelCtor<Model<IBlogComment>> => {
    return sequelize.define<Model<IBlogComment>>("blog_comments", {
        body: {
...
export default BlogCommentFactory;
