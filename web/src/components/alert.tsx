...
export const Alert = ({alertType, alertTitle, alertMessage }:AlertProps) => {
    const alertStyle = {
        alertBackground:{
            backgroundColor: 
    ...
    return (
        <div 
            style={alertStyle.alertBackground}
            className=" m-3 fixed bottom-0 right-0 z-3 rounded-2xl" 
        >
