...
const BlogCard = ({blog, onCheckboxChange}: {blog: Blog, onCheckboxChange: (isChecked: boolean) => void}) => {
    ...
    return (
        ...
        style={{
            ...
            <div className="mb-3 flex flex-col items-center gap-1">
                <h3 className="text-sm font-semibold text-gray-900 text-center">{blog.title}</h3>
                <p className="text-sm  text-justify text-center">Category</p>
                <div className="flex justify-center items-center gap-2">
                    <p className="text-sm text-gray-500 text-justify text-center">Description.</p>
                    <Link 
