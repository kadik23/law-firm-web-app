...
userRouter.get('/services',authMiddleware(["client","admin"]),servicesController.getAllServices);
userRouter.get('/services/:id',authMiddleware(["client","admin"]),servicesController.getOneService);
